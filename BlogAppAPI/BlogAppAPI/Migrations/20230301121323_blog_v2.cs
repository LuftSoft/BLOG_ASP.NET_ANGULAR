        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorDescription = table.Column<string>(type: "ntext", nullable: false),
                    AuthorSlug = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    AuthorPhone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    AuthorEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    AuthorSkill = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagDescription = table.Column<string>(type: "ntext", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostDescription = table.Column<string>(type: "ntext", nullable: false),
                    PostContent = table.Column<string>(type: "ntext", nullable: false),
                    PostSlug = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
